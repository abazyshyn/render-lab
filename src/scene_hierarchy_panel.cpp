...
namespace Lab
{
    ...
    void CSceneHierarchyPanel::DrawComponents(CModel &model)
    {
            ...
            ImGui::DragFloat3("Scale", glm::value_ptr(scale), 0.01f))
        {
            ...
            rotation = glm::rotate(rotation, glm::radians(euler.x), glm::vec3(1, 0, 0));
            rotation = glm::rotate(rotation, glm::radians(euler.y), glm::vec3(0, 1, 0));
            rotation = glm::rotate(rotation, glm::radians(euler.z), glm::vec3(0, 0, 1));

            modelMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(modelMatrix[3])) * rotation;
